...
p1 <- function(formula, data, indices) {
  ...
  fit <- gnlr(d$num_seeds, dist="negative binomial", mu=formula, pmu=c(400,0.50), pshape=1)
  return(fit[[18]][1])
}
...
p2 <- function(formula, data, indices) {
  d <- sample_n(data, 30) # allows boot to select sample
  attach(d)
  fit <- gnlr(num_seeds, dist="negative binomial", mu=formula, pmu=c(543, 0.50), pshape=1)
  return(fit[[18]][2])
}
...
lambda_p <- c(376.9, 23.3)
lambda_v <- c(543, 55.1)
alpha_pv <- c(.29, 0.07)
alpha_vp <- c(0.38, 0.07)
alpha_pp <- c(0.23, 0.03)
alpha_vv <- c(0.58, 0.14)
...
```{r}
lambda_p <- c(489.37, 40.44)
lambda_v <- c(317.3, 37.1)
alpha_pv <- c(0.14, 0.09)
alpha_vp <- c(0.36, 0.06)
alpha_pp <- c(0.48, 0.07)
alpha_vv <- c(0.63, 0.09)
...
# enter parameter estimates with sd's
lambda_p_dry <- c(376.9, 23.3)
lambda_v_dry <- c(543, 55.1)
alpha_pv_dry <- c(.29, 0.07)
alpha_vp_dry <- c(0.38, 0.07)
alpha_pp_dry <- c(0.23, 0.03)
alpha_vv_dry <- c(0.58, 0.14)
